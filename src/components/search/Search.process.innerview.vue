    ...
    <div class="process-info">
      <div>
        ...
        <div class="content-wrap">
          <dl>
            <dt>프로세스 고유 ID</dt>
            <dd>{{propData.processData[0].ProcessGuid}}</dd></dl>
            <dl><dt>프로세스 명</dt>
            <dd>{{propData.processData[0].ProcessName}}</dd></dl>
            <dl><dt>SHA256</dt>
            <dd>{{propData.processData[0].FileHash}}</dd></dl>
            <dl><dt>MD5</dt>
            <dd>{{propData.processData[0].Md5Hash}}</dd></dl>
            <dl><dt>PID</dt>
            <dd>{{propData.processData[0].ProcessId}}</dd></dl>
            <dl><dt>프로세스 경로</dt>
            <dd>{{propData.processData[0].ProcessImagePath}}</dd></dl>
            <dl><dt>Session ID"</dt>
            <dd>{{propData.processData[0].SessionId}}</dd></dl>
          ...
          <dl v-if="propData.processData[0].InteractiveFlag !== '0'">
            ...
            <dl><dt>CommandLine</dt>
            <dd>{{propData.processData[0].CommandLine}}</dd></dl>
            <dl><dt>파일 생성 시각</dt>
            <dd>{{propData.processData[0].CreateDate}}</dd></dl>
            <dl><dt>파일 수정 시각</dt>
            <dd>{{propData.processData[0].InsertTime}}</dd></dl>
            <dl><dt>파일 속성</dt>
            <dd>{{this.propData.processData[0].FileAttributes}}</dd></dl>
            <dl><dt>시작 시각</dt>
            <dd>{{propData.processData[0].EventTime}}</dd></dl>
      ...
      <div>
        ...
        <div class="content-wrap">
            <dl><dt>전자서명</dt>
            <dd>{{propData.fileData.sign_status}}</dd></dl>
          <dl v-if="propData.fileData.sign_status === 'signed'">
            ...
            <dl><dt>회사명</dt>
            <dd>{{propData.fileData.company_name}}</dd></dl>
            <dl><dt>종류</dt>
            <dd>{{propData.fileData.type}}</dd></dl>
            <dl><dt>실행파일 종류</dt>
            <dd>{{propData.fileData.exe_type}} ({{propData.fileData.platform}})</dd></dl>
            <dl><dt>버전</dt>
            <dd>{{propData.fileData.version}}</dd></dl>
            <dl><dt>내부 이름</dt>
            <dd>{{propData.fileData.internal_name}}</dd></dl>
            <dl><dt>제품명</dt>
            <dd>{{propData.fileData.product_name}}</dd></dl>
            <dl><dt>빌드시각</dt>
            <dd>{{propData.fileData.build_date}}</dd></dl>
        </div>
      </div>
      <div>
        <h2>진단 정보</h2>
